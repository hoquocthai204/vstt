...
function HomeContent() {
    ...
    useEffect(() => {
        let speech = document.querySelector('.speech_container') as HTMLElement;
    ...
    return (
        <>
            ...
            <div className='voice' onClick={() => setShowSpeech(!showSpeech)}>
                <i className="fas fa-microphone"></i>
            </div>

            <div className="overlay" onClick={() => setShowSpeech(!showSpeech)}></div>
